...
import static com.boat.objectserializer.$Object$Preconditions.checkArgument;
import static com.boat.objectserializer.$Object$Preconditions.checkNotNull;
import static com.boat.objectserializer.utils.ClassHelper.forName;
...
public class $Object$Types {
    ...
    static Type getSupertype(Type context, Class<?> contextRawType, Class<?> supertype) {
        ...
        return resolve(context, contextRawType,
                $Object$Types.getGenericSupertype(context, contextRawType, supertype));
    }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public boolean equals(Object other) {
            return other instanceof ParameterizedType
                    && $Object$Types.equals(this, (ParameterizedType) other);
        }
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public boolean equals(Object o) {
            return o instanceof GenericArrayType
                    && $Object$Types.equals(this, (GenericArrayType) o);
        }
        ...
        @Override
        public String toString() {
            return GENERIC_ARRAY_TYPE_PREFIX + typeToString(componentType) + "[]";
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public boolean equals(Object other) {
            return other instanceof WildcardType
                    && $Object$Types.equals(this, (WildcardType) other);
        }
        ...
        public String toString() {
            if (lowerBound != null) {
                return WILDCARD_TYPE_PREFIX + "? super " + typeToString(lowerBound);
            } else if (upperBound == Object.class) {
                return WILDCARD_TYPE_PREFIX + "?";
            } else {
                return WILDCARD_TYPE_PREFIX + "? extends " + typeToString(upperBound);
            }
        }
    ...
    public static Type resumeTypeFromToken(String token)  {
        ...
        if (token.startsWith(PARAMETERIZED_TYPE_PREFIX)) {
            ...
            return new GenericArrayTypeImpl(clazz);
        } else if (token.startsWith(WILDCARD_TYPE_PREFIX)) {
            String wildTypeString = token.substring(WILDCARD_TYPE_PREFIX.length());
            String upperBoundSymbol = "? super ";
            if (wildTypeString.startsWith(upperBoundSymbol)) {
                String upperBoundString = wildTypeString.substring(upperBoundSymbol.length());
                Type upperBound = resumeTypeFromToken(upperBoundString);
                return supertypeOf(upperBound);
            }
            String lowBoundSymbol = "? extends ";
            if (wildTypeString.startsWith(lowBoundSymbol)) {
                String lowerBoundString = wildTypeString.substring(lowBoundSymbol.length());
                Type lowerBound = resumeTypeFromToken(lowerBoundString);
